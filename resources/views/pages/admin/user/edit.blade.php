                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control  @error('address') is-invalid @enderror" type="text" id="address"
                                name="address" value="{{ old('address', $user->address) }}" placeholder="" />
                            @error('address')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control  @error('phone') is-invalid @enderror" type="text" id="phone"
                                name="phone" value="{{ old('phone', $user->phone) }}" placeholder="" />
                            @error('phone')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control  @error('license_number') is-invalid @enderror" type="text" id="license_number"
                                name="license_number" value="{{ old('license_number', $user->license_number) }}" placeholder="" />
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="form-control" name="role" id="role">
                                <option disabled selected>{{ old('role', $user->role) }}</option>
